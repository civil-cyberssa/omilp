...
const path = (id: string) => `/api/v1/subscriptions/${encodeURIComponent(id)}/`
...
export async function DELETE(request: NextRequest, { params }: Context) { return proxyMutation(request, path((await params).id), "DELETE") }

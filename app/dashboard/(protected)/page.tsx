...
import { Archive, ArrowRight, FilePenLine, FileText, Plus, Send } from "lucide-react"
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-8">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div><p className="text-sm font-medium text-[#155EEF]">Visão geral</p><h1 className="mt-1 text-3xl font-semibold tracking-tight">Central editorial</h1><p className="mt-2 text-muted-foreground">Acompanhe e publique os documentos da Omi.</p></div>
